                                ...
                                >
                                    ...
                                    <div class="col-span-8 col-start-5 pl-3">
                                        ...
                                        <p class="text-xs pt-2 pb-1">
                                            hot girl tr hot girl tram anh noi
                                            nhu con lao !!!hot girl tram a hot
                                            girl tram anh noi nhu con la hot
                                            girl traao !!!hot girl tram a hot
                                            girl tram anh noi nhu con
                                        </p>
                                    ...
                                    <div class="bg-gray-800 grid grid-cols-12 gap-x-4 pt-2 pl-1">
                                        ...
                                        >
                                            <Link
                                                ...
                                                class="pl-2 title4 "
                                            >
                                                hot girl tram anh noi nhu con
                                                lao !!!hot girl tram anh noi nhu
                                                con lao !!hot girl tram anh noi
                                                nhu con lao !!
                                            </Link>
                                    ...
                                    <ul class=" pl-5 text-xs col-span-12 leading-none grid grid-cols-2 list-none font-semibold border-t mt-2 border-gray-600 py-2">
                                        <li class="my-2 ">
                                            ...
                                            <Link
                                                class="text-red-500  "
                                                href="">
                                                &gt;&gt; Giàu cỡ thần tiên tỷ
                                                tỷĐặng Thu Thảo cũng săn đồ bình
                                                dân trên Shein, giá chưa đến
                                                400k mà diện lên sang chói mắt
                                            </Link>
                                        </li>
                                        <li class="my-2 ">  <span >
                                          20
                    ...
                    <div class="col-span-9 ">
                        ...
                        <div class="grid grid-cols-12 gap-x-4 border-b border-gray-600 py-2">
                            ...
                            >
                                ...
                                <p class="text-xs pt-2 pb-1">
                                    hot girl tr hot girl tram anh noi nhu con
                                    lao !!!hot girl tram a hot girl tram anh noi
                                    nhu con la hot girl traao !!!hot girl tram a
                                    hot girl tram anh noi nhu con
                                </p>
                                <div class="text-right text-xs">
                                    <Link href="/" class="pl-2 ">
                            ...
                            <div class="col-span-6 grid grid-cols-12 gap-x-2">
                                ...
                                <div class="col-span-6 col-start-7">
                                    ...
                                    >
                                      <span class="">
                                    32
                                    </span>   ad aajka aaasdaldkaa ldj!!a
                                    </Link>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-12 gap-x-4  border-b border-gray-600 py-2">
                          ...
                          36
                            ...
                            <div class="col-span-4 col-start-5">
                                ...
                                <p class="text-content ">
                                    hfsdks kfhsklhf snaklh afkn nsafj asjfwie
                                    fsdknf s,f hfsdks kfhsklhf snaklh afkn nsafj
                                    asjfwie fsdknf s,f
                                </p>
                            </div>
                            <div class="col-start-9 col-span-4">
                                <Link
                                    class="mb-0.5 block title5"
                                    href={"/"}
                                >
                                <span class="">
                                   37
                                    </span>     aasasdsf sdf sd fsdf sdf sf fsdf{" "}
                                </Link>
                                <Link
                                    class="mb-0.5 block title5"
                                    href={"/"}
